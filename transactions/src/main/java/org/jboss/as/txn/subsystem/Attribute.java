...
enum Attribute {
    ...
    TRANSACTIONS_RECOVERY_GRACEFUL_SHUTDOWN(CommonAttributes.TRANSACTIONS_RECOVERY_GRACEFUL_SHUTDOWN),
    GRACEFUL_SHUTDOWN_TIMEOUT(CommonAttributes.GRACEFUL_SHUTDOWN_TIMEOUT)
    ;
