...
class TransactionSubsystemAdd extends AbstractBoottimeAddStepHandler {
    ...
    private void populateModelWithRecoveryEnvConfig(ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        TransactionSubsystemRootResourceDefinition.STOP_RECOVERY_WHEN_SUSPENDING.validateAndSet(operation, model);
    }
    ...
    private void performRecoveryEnvBoottime(OperationContext context, ModelNode model, final boolean jts, List<ServiceName> deps) throws OperationFailedException {
        ...
        final boolean isRecoveryStoppedWhenSuspending = TransactionSubsystemRootResourceDefinition.STOP_RECOVERY_WHEN_SUSPENDING.resolveModelAttribute(context, model).asBoolean();
        ...
        configurator.setStopRecoveryManagerOnSuspension(isRecoveryStoppedWhenSuspending);
