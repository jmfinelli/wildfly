...
public class TransactionTransformers implements ExtensionTransformerRegistration {
    ...
    static final ModelVersion MODEL_VERSION_WILDFLY40 = ModelVersion.create(7, 0);
    ...
    public void registerTransformers(SubsystemTransformerRegistration subsystemRegistration) {
        ...
        // 8.0.0 --> 7.0.0
        ResourceTransformationDescriptionBuilder builderWF40 = chainedBuilder.createBuilder(CURRENT_MODEL_VERSION, MODEL_VERSION_WILDFLY40);
        builderWF40.getAttributeBuilder()
        ...
        // 7.0.0 --> 6.0.0
        ResourceTransformationDescriptionBuilder builder81 = chainedBuilder.createBuilder(MODEL_VERSION_WILDFLY40, MODEL_VERSION_EAP81);
        ...
        chainedBuilder.buildAndRegister(subsystemRegistration, new ModelVersion[]{MODEL_VERSION_WILDFLY40, MODEL_VERSION_EAP81});
    }
}
