        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attribute) {
                ...
                case RECOVERY_BACKOFF_PERIOD:
                    ...
                    break;
                case STOP_RECOVERY_WHEN_SUSPENDING:
                    TransactionSubsystemRootResourceDefinition.STOP_RECOVERY_WHEN_SUSPENDING.parseAndSetParameter(value, operation, reader);
                    break;
                default:
                    throw unexpectedAttribute(reader, i);
            }
