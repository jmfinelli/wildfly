...
class TransactionSubsystemXMLPersister implements XMLElementWriter<SubsystemMarshallingContext> {
    ...
    public void writeContent(XMLExtendedStreamWriter writer, SubsystemMarshallingContext context) throws XMLStreamException {
        ...
        if (TransactionSubsystemRootResourceDefinition.BINDING.isMarshallable(node) ||
                ...
                TransactionSubsystemRootResourceDefinition.STOP_RECOVERY_WHEN_SUSPENDING.isMarshallable(node) ) {
            ...
            TransactionSubsystemRootResourceDefinition.STOP_RECOVERY_WHEN_SUSPENDING.marshallAsAttribute(node, writer);
