 ...
 * </p>
 * <p>
 * If the {@link TransactionSubsystemRootResourceDefinition#STOP_RECOVERY_WHEN_SUSPENDING} is configured with value {@code false}
...
public class RecoverySuspendController implements ServerActivity, PropertyChangeListener {
     ...
     * when not disallowed by attribute {@link TransactionSubsystemRootResourceDefinition#STOP_RECOVERY_WHEN_SUSPENDING}
    ...
    public void preSuspend(ServerActivityCallback serverActivityCallback) {
        ...
        if (configurator.isRecoveryManagerStoppedOnSuspension()) {
