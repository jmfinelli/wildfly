...
public class TransactionRecoverOperationTestCase extends AbstractCliTestBase {
    ...
    private static final String STOP_RECOVERY_WHEN_SUSPENDING_ATTRIBUTE_NAME = "stop-recovery-when-suspending";
    ...
    public void testRecovery() throws Exception {
        ...
        container.start(CONTAINER);
        assertState("running", CLI_INIT_TIMEOUT, CLI_OPERATION_READ_SERVER_STATE);
        // There should be unfinished transactions in the object store
        // No reboot required for changing the value of RECOVERY_PERIOD_ATTRIBUTE_NAME
    ...
    // ----
    // TODO: add a test to check behaviour during suspension
    // ----
